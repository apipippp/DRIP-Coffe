...
class Auth extends CI_Controller
{
    ...
    // Constructor - Inisialisasi controller, load model & library
    ...
    // Proses login user (verifikasi email & password)
    ...
    // Proses registrasi user baru (validasi form & simpan data)

...
class Kasir extends CI_Controller
{
    ...
    // Constructor - Cek autentikasi kasir, load model
    ...
    // Dashboard kasir - lihat pesanan & revenue
    ...
    // Ubah status pesanan dari pending ke processing
